...
use AptoName\Traits\Settings as SettingsFields;
...
class Settings {
    ...
    public function addSettingsMenu(){
        $page = add_submenu_page( 'apto-name','Apto Name Settings', 'Settings', 'manage_options' , 'apto-name-settings',  array( $this, 'settingsPage' ) );
    }
...
//        echo $plugin_file;
        if( $plugin_file === 'apto-name/apto-name.php' ) {
